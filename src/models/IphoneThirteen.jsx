...
Command: npx gltfjsx@6.1.3 iphone13.gltf
...
export function IphoneThirteen(props) {
  const { nodes, materials } = useGLTF('/apple_iphone_13_pro_max/IphoneThirteen.gltf')
  return (
...
useGLTF.preload('/apple_iphone_13_pro_max/IphoneThirteen.gltf')
